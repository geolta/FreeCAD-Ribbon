...
################################################################################
## Form generated from reading UI file 'SettingsceOzPT.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QRect(450, 10, 88, 22))
        ...
        self.widget1.setGeometry(QRect(10, 20, 191, 103))
        self.verticalLayout_2 = QVBoxLayout(self.widget1)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.AutoHide = QCheckBox(self.widget1)
        ...
        self.IconSize_Small = QSpinBox(self.widget1)
        ...
        self.IconSize_Medium = QSpinBox(self.widget1)
        ...
        self.Large = QSpinBox(self.widget1)
        self.Large.setObjectName(u"Large")
        sizePolicy4.setHeightForWidth(self.Large.sizePolicy().hasHeightForWidth())
        self.Large.setSizePolicy(sizePolicy4)
        self.Large.setMinimumSize(QSize(20, 0))
        self.Large.setFont(font1)
        self.Large.setAlignment(Qt.AlignCenter)
        self.Large.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.Large.setValue(64)

        self.horizontalLayout_7.addWidget(self.Large)
        ...
        self.groupBox2.setMinimumSize(QSize(0, 60))
        self.groupBox2.setFont(font1)
        self.layoutWidget4 = QWidget(self.groupBox2)
        ...
        self.gridLayout_8.addWidget(self.groupBox2, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_12.setText(QCoreApplication.translate("Form", u"Size of large icons:", None))
        ...
        self.groupBox2.setTitle(QCoreApplication.translate("Form", u"Backup location", None))
