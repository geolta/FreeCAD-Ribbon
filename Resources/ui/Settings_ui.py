...
################################################################################
## Form generated from reading UI file 'SettingsNCsjrT.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabToolbar.setObjectName(u"tabToolbar")
    ...
    def retranslateUi(self, Form):
        ...
        self.tabToolbar.setTabText(self.tabToolbar.indexOf(self.QAToolbars), QCoreApplication.translate("Form", u"Quick access toolbar", None))
        ...
        self.tabToolbar.setTabText(self.tabToolbar.indexOf(self.Workbenches), QCoreApplication.translate("Form", u"Workbenches", None))
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Form", u"Icon only", None));
        ...
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Form", u"Command 1", None));
        ...
        self.tabToolbar.setTabText(self.tabToolbar.indexOf(self.RibbonDesign), QCoreApplication.translate("Form", u"Ribbon design", None))
    # retranslateUi
